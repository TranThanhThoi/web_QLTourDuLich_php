...
if(isset($_POST['tim-kiem'])) {
    $tim_kiem = $_POST['tim-kiem'];
    $qr = "select * from v_hoas where id_hoas = '$tim_kiem' or ten_hoas like '%$tim_kiem%' or tenhoa like '%$tim_kiem%' GROUP BY id_hoas";
    echo "<div class=\"cross-line\" style='text-transform: capitalize'>Kết quả tìm kiếm: $tim_kiem</div>";
}
