...
if(isset($_POST['email']))
{
    $vl = $_POST['email'];
    if($vl != "") {
        $ql2 = "select email from khachhang where email='$vl'";
        ...
        if (mysqli_num_rows($kq2) != 0 || mysqli_num_rows($kq3) != 0) {
            echo "<input class=\"form-control\" name=\"youremail\" placeholder=\"Email\" type=\"email\" required id=\"email\" onblur=\"load_ajax()\" value=\"$vl\" />";
        ...
        echo "<input class=\"form-control\" name=\"youremail\" type=\"email\" required id=\"email\" onblur=\"load_ajax()\" pattern=\"[a-zA-Z0-9]+\" placeholder=\"Không được để trống trường này.\" />";
        echo "<span class=\"glyphicon glyphicon-remove form-control-feedback\"></span>";
    }
}
